...
def updateApriltagStuff(id, poseT):
    table.putNumber("Apriltag {a} X: ".format(a=id), pose[0])
    table.putNumber("Apriltag {a} Y: ".format(a=id), pose[2])
    table.putNumber("Apriltag {a} Z: ".format(a=id), math.sqrt(pow(pose[0], 2) +  pow(pose[2], 2)))

def updateApriltagStuff():
    table.putNumber("Apriltag {a} X: ".format(a=id), 0)
    table.putNumber("Apriltag {a} Y: ".format(a=id), 0)
    table.putNumber("Apriltag {a} Z: ".format(a=id), 0)
